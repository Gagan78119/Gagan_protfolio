...
const Hero = () => {
  ...
  return <section id="hero" className="min-h-screen flex items-center bg-gradient-to-br from-gray-50 to-white relative overflow-hidden pt-20">
      {/* Background pattern */}
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="flex flex-wrap gap-4 my-0">
              <a href="#contact" className="px-8 py-3 bg-blue-500 text-white rounded-full hover:bg-blue-600 transition-all transform hover:scale-105">
                Hire Me
              </a>
              <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" className="px-8 py-3 border-2 border-gray-300 text-gray-700 rounded-full hover:border-blue-500 hover:text-blue-500 transition-all transform hover:scale-105">
                Whatsapp
              </a>
            </div>
          </div>
          ...
          <div className={`relative transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="relative">
              ...
              <img alt="Amar Akram - Web Designer and Developer" src="/lovable-uploads/af7a47d6-b34d-49d7-98d7-381e6005c973.jpg" className="relative z-10 mx-auto object-fill" />
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-blue-500 text-white overflow-hidden mx-0 rounded-2xl px-0 py-[11px] my-[9px]">
